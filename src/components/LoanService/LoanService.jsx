  ...
  return (
    <div>
      <div className="lg:px-[90px] text-center p-4">
        ...
        Samast Bharat Finance (SB-Finance) offers a wide range of loan services designed to meet the diverse financial needs of our customers. Whether you need funds for personal reasons, business expansion, or emergencies, we have the perfect loan options for you. Our loan services include short-term loans, long-term loans, personal loans, business loans, and more.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 px-4 lg:px-20 py-8">
        {/* Row 1 */}
        <div className="lg:col-span-6 col-span-12 bg-[#f4e5ff] shadow-lg rounded-lg p-6 text-center transform transition hover:scale-105 hover:shadow-xl">
        ...
        <div className="lg:col-span-3 col-span-12 bg-[#fef1e9] shadow-lg rounded-lg p-6 text-center transform transition hover:scale-105 hover:shadow-xl">
          <div className="text-4xl mb-4">
            <img
        ...
        <div className="lg:col-span-3 col-span-12 bg-[#e2f7f3] shadow-lg rounded-lg p-6 text-center transform transition hover:scale-105 hover:shadow-xl">
          <div className="text-4xl mb-4">
            <img
        ...
        {/* Row 2 */}
        <div className="lg:col-span-3 col-span-12 bg-[#ff8d8e] shadow-lg rounded-lg p-6 text-center transform transition hover:scale-105 hover:shadow-xl">
          <div className="text-4xl mb-4">
            <img
        ...
        <div className="lg:col-span-6 col-span-12 bg-[#ffd2a6] shadow-lg rounded-lg p-6 text-center transform transition hover:scale-105 hover:shadow-xl">
          <div className="text-4xl mb-4">
            <img
